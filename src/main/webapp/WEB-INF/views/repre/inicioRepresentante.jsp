            ...
            <nav>
                ...
                <div class="collapse mt-3" id="menu-documentos">
                    <ul class="men">
                        ...
                        <li class="opciones"><a href="${pageContext.request.contextPath}/ServletAsignaciones?accion=3&&depa=${sessionScope.departamento}"><div class="icono-l">
                    ...
                    <div class="row">
                        <div class="col-12 d-flex justify-content-center">
                            <div class="titulo">
                                ...
                                <h3 class="bienvenida">Bienvenido ${sessionScope.idUsuario} Jefe de ${sessionScope.departamento}</h3>
