        ...
        <main class="col-10 col-md-9 bg-ligth px-3">
            <div class="contenido bg-ligth ">
                ...
                <div class="body ">
                    ...
                    <div class="row">
                        <div class="col-12 d-lg d-flex justify-content-center mt-4">
                                        ...
                                        <div class="body-form d-flex justify-content-center p-5">
                                            <form action="${pageContext.request.contextPath}/ServletEmpleados" method="post">
                                                ...
                                                <div class="boton d-flex justify-content-center mt-5">
                                                    <div class="botones">
                                                        <button  type="submit" class="btn boton-enviar btn-primary">
                                                            Guardar
                                                        </button>
                                                    </div>
                                                    <div class="botones">
                                                        <button type="reset" class="btn botones btn-outline-danger">
                                                            Cancelar
                                                        </button>
                                                    </div>
                                                </div>
